...
// LocalStorage so that once user has logged in, credentials is stored in browser,
// not in Redux store which is only available per tab/session instead of browser.
